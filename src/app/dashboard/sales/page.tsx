...
export default async function SalesPage() {
  ...
  const serialized = sales.map((sale) => ({
    ...
    payments: sale.payments.map((payment) => ({
      ...
      coveredBaseUsd: toStr(payment.coveredBaseUsd),
      surchargePct: toStr(payment.surchargePct),
      surchargeAmount: toStr(payment.surchargeAmount),
      installments: payment.installments,
      installmentAmount: toStr(payment.installmentAmount),
