  ...
  return (
    <DashboardLayout activeTab="sales">
      ...
      <div className="flex flex-col gap-4">
        <h1>// Acá va una tabla CLIENTES o algo Charleston !!!</h1>
        {/* <FilterableSalesTable initial={serialized} /> */}
        <img src="https://media.giphy.com/media/vFKqnCdLPNOKc/giphy.gif" className='rounded-box' width="400" height="400" />
      </div>
    </DashboardLayout>
  )
}
